    ...
    if ($action === 'send_otp') {
        if (empty($email)) {
            ...
            if (!checkPasswordResetRateLimit($pdo, $email)) {
                ...
                $step = 'verify';
                $message = 'We have sent a 6-digit OTP to your email if an account exists. Enter the code below to reset your password.';
            }
        }
    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p><?php echo $step === 'request' ? 'Enter your email to receive a one-time OTP.' : ($step === 'verify' ? 'Enter the OTP sent to your email and set a new password.' : ''); ?></p>
            </div>
            ...
            <div class="auth-footer">
                ...
                <p><a href="forgot_password_simple.php">Simple Mode (No OTP)</a></p>
            </div>
        </div>
    </div>
